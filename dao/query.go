...
func QuerysByLimit[t T](db *gorm.DB, data t, limit int, offset int) ([]t, bool) { //检索多个对象
	var datas []t
...
func QuerysByCur[t T](db *gorm.DB, data t, limit int, cur int) ([]Article, int, bool) { //检索多个对象
	var datas []Article
